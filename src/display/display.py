...
def createPPM(text_color_pairs):    # メッセージを ppm ファイルに変換
    ...
    proc = subprocess.Popen([f"exec /home/pi/experiment2022/src/rpi-rgb-led-matrix/examples-api-use/scrolling-text-example --led-cols=64 --led-rows=32 --led-chain=2 --led-no-hardware-pulse --led-slowdown-gpio=4 -l 2 -f /home/pi/Downloads/fonts/sazanami-20040629/sazanami-mincho.bdf \"{whole_text}\""], shell = True)
